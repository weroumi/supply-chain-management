...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(
      ...
      typeof define === 'function' && define.amd ? define(['exports'], factory)
          ...
          (global = typeof globalThis !== 'undefined' ? globalThis : global
              || self, factory(global.d3 = global.d3 || {}));
  ...
  function ascending$3(a, b) {
    return a == null || b == null ? NaN : a < b ? -1 : a > b ? 1 : a >= b ? 0
        : NaN;
  }
  ...
  function blurf(radius) {
    ...
    return (T, S, start, stop, step) => { // stop must be aligned!
      ...
      for (let i = start, j = stop; i <= j; i += step) {
        ...
        T[i] = (sum + t * (S[Math.max(start, i - s1)] + S[Math.min(stop,
            i + s1)])) / w;
...
// Like blurf, but optimized for integer radius.
  ...
  function cross$2(...values) {
    const reduce = typeof values[values.length - 1] === "function" && reducer(
        values.pop());
...
// https://github.com/python/cpython/blob/a74eea238f5baba15797e2e8b570d153bc8690a7/Modules/mathmodule.c#L1423
  ...
  class InternMap extends Map {
    constructor(entries, key = keyof) {
      ...
      Object.defineProperties(this,
          {_intern: {value: new Map()}, _key: {value: key}});
      if (entries != null) {
  ...
  function keyof(value) {
    return value !== null && typeof value === "object" ? value.valueOf()
        : value;
  }
  ...
  function flatten$1(groups, keys) {
    for (let i = 1, n = keys.length; i < n; ++i) {
      groups = groups.flatMap(
          g => g.pop().map(([key, value]) => [...g, key, value]));
    }
    return groups;
  }
  ...
  function ascendingDefined(a, b) {
    return (a == null || !(a >= a)) - (b == null || !(b >= b)) || (a < b ? -1
        : a > b ? 1 : 0);
  }

  function groupSort(values, reduce, key) {
    return (reduce.length !== 2
        ? sort(rollup(values, reduce, key),
            (([ak, av], [bk, bv]) => ascending$3(av, bv) || ascending$3(ak,
                bk)))
        : sort(group(values, key),
  ...
  function ticks(start, stop, count) {
    ...
    const reverse = stop < start, [i1, i2, inc] = reverse ? tickSpec(stop,
        start, count) : tickSpec(start, stop, count);
    if (!(i2 >= i1)) {
      return [];
    }
  ...
  function tickStep(start, stop, count) {
    ...
    const reverse = stop < start,
        inc = reverse ? tickIncrement(stop, start, count) : tickIncrement(start,
            stop, count);
  ...
  function bin() {
    ...
    histogram.thresholds = function (_) {
      return arguments.length ? (threshold = typeof _ === "function" ? _
              : constant$b(Array.isArray(_) ? slice$3.call(_) : _), histogram)
          : threshold;
    };
...
// ISC license, Copyright 2018 Vladimir Agafonkin.
  function quickselect(array, k, left = 0, right = Infinity, compare) {
    ...
    compare = compare === undefined ? ascendingDefined : compareDefined(
        compare);
  ...
  function quantileIndex(values, p, valueof = number$3) {
    ...
    numbers = Float64Array.from(values,
        (_, i) => number$3(valueof(values[i], i, values)));
    if (p <= 0) {
      return minIndex(numbers);
    }
    if (p >= 1) {
      return maxIndex(numbers);
    }
    var numbers,
        index = Uint32Array.from(values, (_, i) => i),
        j = numbers.length - 1,
        i = Math.floor(j * p);
    quickselect(index, i, 0, j,
        (i, j) => ascendingDefined(numbers[i], numbers[j]));
  ...
  function range$2(start, stop, step) {
    start = +start, stop = +stop, step = (n = arguments.length) < 2
        ? (stop = start, start = 0, 1) : n < 3 ? 1 : +step;
  ...
  function rank(values, valueof = ascending$3) {
    ...
    values.sort(valueof === ascending$3 ? (i, j) => ascendingDefined(V[i], V[j])
  ...
  function transpose(matrix) {
    ...
    for (var i = -1, m = min$2(matrix, length$2), transpose = new Array(m);
        ++i < m;) {
  ...
  function axis(orient, scale) {
    ...
    function axis(context) {
      var values = tickValues == null ? (scale.ticks ? scale.ticks.apply(scale,
          ...
          format = tickFormat == null ? (scale.tickFormat
                  ? scale.tickFormat.apply(scale, tickArguments) : identity$8)
              : tickFormat,
      ...
      if (context !== selection) {
        ...
        .attr("transform", function (d) {
          return isFinite(d = position(d)) ? transform(d + offset)
      ...
      .attr("d", orient === left || orient === right
          ? (tickSizeOuter ? "M" + k * tickSizeOuter + "," + range0 + "H"
              + offset + "V" + range1 + "H" + k * tickSizeOuter : "M" + offset
              + "," + range0 + "V" + range1)
          : (tickSizeOuter ? "M" + range0 + "," + k * tickSizeOuter + "V"
              + offset + "H" + range1 + "V" + k * tickSizeOuter : "M" + range0
              + "," + offset + "H" + range1));
    ...
    axis.tickArguments = function (_) {
      return arguments.length ? (tickArguments = _ == null ? [] : Array.from(
          _), axis) : tickArguments.slice();
    };

    axis.tickValues = function (_) {
      return arguments.length ? (tickValues = _ == null ? null : Array.from(
          _), axis) : tickValues && tickValues.slice();
    };
  ...
  function dispatch() {
    for (var i = 0, n = arguments.length, _ = {}, t; i < n; ++i) {
      if (!(t = arguments[i] + "") || (t in _) || /[\s.]/.test(
          t)) {
  ...
  Dispatch.prototype = dispatch.prototype = {
    ...
    apply: function (type, that, args) {
      ...
      for (var t = this._[type], i = 0, n = t.length; i < n;
          ++i) {
  ...
  function selection_select(select) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = new Array(m),
        j = 0; j < m; ++j) {
      for (var group = groups[j], n = group.length,
          subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n;
          ++i) {
...
// static NodeList as a group, since it safely derived from querySelectorAll.
  ...
  function selection_filter(match) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = new Array(m),
        j = 0; j < m; ++j) {
      for (var group = groups[j], n = group.length,
          subgroup = subgroups[j] = [], node, i = 0; i < n; ++i) {
...
// don’t; we’d rather avoid a gratuitous copy.)
  ...
  function selection_order() {
    ...
    for (var groups = this._groups, j = -1, m = groups.length; ++j < m;) {
      for (var group = groups[j], i = group.length - 1, next = group[i], node;
          --i >= 0;) {
        if (node = group[i]) {
          if (next && node.compareDocumentPosition(next)
              ^ 4) {
  ...
  function selection_sort(compare) {
    ...
    for (var groups = this._groups, m = groups.length,
      ...
      for (var group = groups[j], n = group.length,
          sortgroup = sortgroups[j] = new Array(n), node, i = 0; i < n; ++i) {
        if (node = group[i]) {
          sortgroup[i] = node;
        }
      }
  ...
  function styleValue(node, name) {
    return node.style.getPropertyValue(name)
        || defaultView(node).getComputedStyle(node, null).getPropertyValue(
            name);
  }
      ...
      if (on) {
        for (var j = 0, m = on.length; j < m; ++j) {
          if ((o = on[j]).type === typename.type && o.name === typename.name) {
            this.removeEventListener(o.type, o.listener, o.options);
            this.addEventListener(o.type, o.listener = listener,
                o.options = options);
            o.value = value;
            return;
          }
  ...
  function dispatchEvent(node, type, params) {
    ...
    if (typeof event === "function") {
      ...
      if (params) {
        event.initEvent(type, params.bubbles,
            params.cancelable), event.detail = params.detail;
      } else {
...
// Ignore right-click, since that should open the context menu.
  ...
  function color(format) {
    ...
    return (m = reHex.exec(format)) ? (l = m[1].length, m = parseInt(m[1],
            16), l === 6 ? rgbn(m) // #ff0000
            : l === 3 ? new Rgb((m >> 8 & 0xf) | (m >> 4 & 0xf0),
                    (m >> 4 & 0xf) | (m & 0xf0), ((m & 0xf) << 4) | (m & 0xf), 1) // #f00
                : l === 8 ? rgba(m >> 24 & 0xff, m >> 16 & 0xff, m >> 8 & 0xff,
                        (m & 0xff) / 0xff) // #ff000000
                    : l === 4 ? rgba((m >> 12 & 0xf) | (m >> 8 & 0xf0),
                            (m >> 8 & 0xf) | (m >> 4 & 0xf0),
                            (m >> 4 & 0xf) | (m & 0xf0),
                            (((m & 0xf) << 4) | (m & 0xf)) / 0xff) // #f000
                        : null) // invalid hex
        : (m = reRgbInteger.exec(format)) ? new Rgb(m[1], m[2], m[3], 1) // rgb(255, 0, 0)
            : (m = reRgbPercent.exec(format)) ? new Rgb(m[1] * 255 / 100,
                    m[2] * 255 / 100, m[3] * 255 / 100, 1) // rgb(100%, 0%, 0%)
                : (m = reRgbaInteger.exec(format)) ? rgba(m[1], m[2], m[3],
                        m[4]) // rgba(255, 0, 0, 1)
                    : (m = reRgbaPercent.exec(format)) ? rgba(m[1] * 255 / 100,
                            m[2] * 255 / 100, m[3] * 255 / 100, m[4]) // rgb(100%, 0%, 0%, 1)
                        : (m = reHslPercent.exec(format)) ? hsla(m[1],
                                m[2] / 100, m[3] / 100, 1) // hsl(120, 50%, 50%)
                            : (m = reHslaPercent.exec(format)) ? hsla(m[1],
                                    m[2] / 100, m[3] / 100, m[4]) // hsla(120, 50%, 50%, 1)
                                : named.hasOwnProperty(format) ? rgbn(
                                        named[format]) // eslint-disable-line no-prototype-builtins
                                    : format === "transparent" ? new Rgb(NaN,
                                            NaN, NaN, 0)
                                        : null;
  }
  ...
  function rgb(r, g, b, opacity) {
    return arguments.length === 1 ? rgbConvert(r) : new Rgb(r, g, b,
  ...
  define(Rgb, rgb, extend(Color, {
    ...
    clamp() {
      return new Rgb(clampi(this.r), clampi(this.g), clampi(this.b),
          clampa(this.opacity));
    },
    displayable() {
  ...
  function hsl$2(h, s, l, opacity) {
    return arguments.length === 1 ? hslConvert(h) : new Hsl(h, s, l,
        opacity == null ? 1 : opacity);
  }
  ...
  define(Hsl, hsl$2, extend(Color, {
    ...
    clamp() {
      return new Hsl(clamph(this.h), clampt(this.s), clampt(this.l),
          clampa(this.opacity));
    },
    displayable() {
    ...
    formatHsl() {
      const a = clampa(this.opacity);
      return `${a === 1 ? "hsl(" : "hsla("}${clamph(this.h)}, ${clampt(this.s)
      * 100}%, ${clampt(this.l) * 100}%${a === 1 ? ")" : `, ${a})`}`;
    }
  }));
...
// https://observablehq.com/@mbostock/lab-and-rgb
  ...
  function lab$1(l, a, b, opacity) {
    return arguments.length === 1 ? labConvert(l) : new Lab(l, a, b,
        opacity == null ? 1 : opacity);
  }
  ...
  function lch(l, c, h, opacity) {
    return arguments.length === 1 ? hclConvert(l) : new Hcl(h, c, l,
        opacity == null ? 1 : opacity);
  }

  function hcl$2(h, c, l, opacity) {
    return arguments.length === 1 ? hclConvert(h) : new Hcl(h, c, l,
        opacity == null ? 1 : opacity);
  }
  ...
  function hue$1(a, b) {
    var d = b - a;
    return d ? linear$2(a,
        d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant$8(
        isNaN(a) ? b : a);
  }
                    ...
                    : b instanceof Date ? date$1
                        : isNumberArray(b) ? numberArray
                            : Array.isArray(b) ? genericArray
                                ...
                                && typeof b.toString !== "function" || isNaN(b)
                                    ? object$1
  ...
  var frame = 0, // is an animation frame pending?
      ...
      setFrame = typeof window === "object" && window.requestAnimationFrame
          ? window.requestAnimationFrame.bind(window) : function (f) {
            setTimeout(f, 17);
          };
  ...
  function sleep(time) {
    ...
    if (delay > 24) {
      if (time < Infinity) {
        timeout$1 = setTimeout(wake,
            time - clock.now() - clockSkew);
      }
      if (interval$1) {
      ...
      if (!interval$1) {
        clockLast = clock.now(), interval$1 = setInterval(poke,
            pokeDelay);
      }
  ...
  function create(node, id, self) {
    ...
    function tick(elapsed) {
      var t = elapsed < self.duration ? self.ease.call(null,
              elapsed / self.duration) : (self.timer.restart(
              stop), self.state = ENDING, 1),
          i = -1,
          n = tween.length;
  ...
  function tweenFunction(id, name, value) {
    ...
    return function () {
      ...
      if (tween !== tween0) {
        ...
        for (var t = {name: name, value: value}, i = 0, n = tween1.length;
            i < n; ++i) {
          if (tween1[i].name === name) {
            tween1[i] = t;
            break;
  ...
  function attrFunctionNS(fullname, interpolate, value) {
    ...
    return function () {
      var string0, value1 = value(this), string1;
      if (value1 == null) {
        return void this.removeAttributeNS(fullname.space,
            fullname.local);
      }
  ...
  function transition_attr(name, value) {
    ...
    return this.attrTween(name, typeof value === "function"
        ...
        : value == null ? (fullname.local ? attrRemoveNS : attrRemove)(fullname)
            : (fullname.local ? attrConstantNS : attrConstant)(fullname, i,
                value));
  }
  ...
  function transition_merge(transition) {
    ...
    for (var groups0 = this._groups, groups1 = transition._groups,
        m0 = groups0.length, m1 = groups1.length, m = Math.min(m0, m1),
        merges = new Array(m0), j = 0; j < m; ++j) {
      for (var group0 = groups0[j], group1 = groups1[j], n = group0.length,
          merge = merges[j] = new Array(n), node, i = 0; i < n; ++i) {
  ...
  function styleFunction(name, interpolate, value) {
    ...
    return function () {
      var string0 = styleValue(this, name),
          ...
          string1 = value1 + "";
      if (value1 == null) {
        string1 = value1 = (this.style.removeProperty(
            name), styleValue(this, name));
      }
      return string0 === string1 ? null
          : string0 === string00 && string1 === string10 ? interpolate0
              : (string10 = string1, interpolate0 = interpolate(
  ...
  function styleMaybeRemove(id, name) {
    var on0, on1, listener0, key = "style." + name, event = "end." + key,
        remove;
    return function () {
      var schedule = set(this, id),
          on = schedule.on,
          listener = schedule.value[key] == null ? remove
              || (remove = styleRemove(name)) : undefined;
...
// tpmt is two power minus ten times t scaled to [0,1]
  ...
  function circleInOut(t) {
    return ((t *= 2) <= 1 ? 1 - Math.sqrt(1 - t * t) : Math.sqrt(
        1 - (t -= 2) * t) + 1) / 2;
  }
...
// Like d3.local, but with the name “__brush” rather than auto-generated.
  ...
  function brush$1(dim) {
      ...
      if (group.tween) {
        ...
        .tween("brush", function () {
          var that = this,
              ...
              selection1 = dim.input(
                  typeof selection === "function" ? selection.apply(this,
                      arguments) : selection, state.extent),
        ...
        .each(function () {
          var that = this,
              ...
              state = that.__brush,
              selection1 = dim.input(
                  typeof selection === "function" ? selection.apply(that, args)
    ...
    function redraw() {
      ...
      if (selection) {
        ...
        .style("display", null)
        .attr("x", function (d) {
          return d.type[d.type.length - 1] === "e" ? selection[1][0]
              - handleSize / 2 : selection[0][0] - handleSize / 2;
        })
        .attr("y", function (d) {
        ...
        .attr("width", function (d) {
          return d.type === "n" || d.type === "s" ? selection[1][0]
              - selection[0][0] + handleSize : handleSize;
        })
        .attr("height", function (d) {
          return d.type === "e" || d.type === "w" ? selection[1][1]
              - selection[0][1] + handleSize : handleSize;
        });
      } else {
    ...
    Emitter.prototype = {
      ...
      start: function (event, mode) {
        if (this.starting) {
          this.starting = false, this.emit("start", event,
              mode);
        } else {
    ...
    function started(event) {
      ...
      var that = this,
          ...
          === "selection" ? MODE_DRAG : (keys && event.altKey ? MODE_CENTER
              : MODE_HANDLE),
      ...
      function move(event) {
        ...
        switch (mode) {
          ...
          case MODE_DRAG: {
            if (signX) {
              dx = max$2(W - w0, min$1(E - e0, dx)), w1 = w0
                  + dx, e1 = e0 + dx;
            }
            if (signY) {
              dy = max$2(N - n0, min$1(S - s0, dy)), n1 = n0
                  + dy, s1 = s0 + dy;
            }
            break;
          }
          case MODE_HANDLE: {
            if (points[1]) {
              if (signX) {
                w1 = max$2(W, min$1(E, points[0][0])), e1 = max$2(W,
                    min$1(E, points[1][0])), signX = 1;
              }
              if (signY) {
                n1 = max$2(N, min$1(S, points[0][1])), s1 = max$2(N,
                    min$1(S, points[1][1])), signY = 1;
              }
            } else {
              if (signX < 0) {
                dx = max$2(W - w0, min$1(E - w0, dx)), w1 = w0
                    + dx, e1 = e0;
              } else if (signX > 0) {
                dx = max$2(W - e0,
                    min$1(E - e0, dx)), w1 = w0, e1 = e0 + dx;
              }
              if (signY < 0) {
                dy = max$2(N - n0, min$1(S - n0, dy)), n1 = n0
                    + dy, s1 = s0;
              } else if (signY > 0) {
                dy = max$2(N - s0,
          ...
          case MODE_CENTER: {
            if (signX) {
              w1 = max$2(W, min$1(E, w0 - dx * signX)), e1 = max$2(W,
                  min$1(E, e0 + dx * signX));
            }
            if (signY) {
              n1 = max$2(N, min$1(S, n0 - dy * signY)), s1 = max$2(N,
                  min$1(S, s0 + dy * signY));
            }
            break;
          }
  ...
  function chord$1(directed, transpose) {
    ...
    function chord(matrix) {
      ...
      for (let i = 0; i < n; ++i) {
        let x = 0;
        for (let j = 0; j < n; ++j) {
          x += matrix[i * n + j] + directed * matrix[j
          * n + i];
        }
        k += groupSums[i] = x;
      }
      ...
      // Compute the angles for each group and constituent chord.
      {
        ...
        if (sortGroups) {
          groupIndex.sort(
              (a, b) => sortGroups(groupSums[a], groupSums[b]));
        }
        for (const i of groupIndex) {
          const x0 = x;
          if (directed) {
            const subgroupIndex = range$1(~n + 1, n).filter(
                j => j < 0 ? matrix[~j * n + i] : matrix[i * n + j]);
            if (sortSubgroups) {
              subgroupIndex.sort((a, b) => sortSubgroups(
                  a < 0 ? -matrix[~a * n + i] : matrix[i * n + a],
                  b < 0 ? -matrix[~b * n + i] : matrix[i * n + b]));
            }
            for (const j of subgroupIndex) {
              if (j < 0) {
                const chord = chords[~j * n + i] || (chords[~j * n
                + i] = {source: null, target: null});
                chord.target = {
                  index: i,
                  startAngle: x,
                ...
                const chord = chords[i * n + j] || (chords[i * n
                + j] = {source: null, target: null});
                chord.source = {
                  index: i,
                  startAngle: x,
            ...
            if (sortSubgroups) {
              subgroupIndex.sort(
                  (a, b) => sortSubgroups(matrix[i * n + a],
                      matrix[i * n + b]));
            }
            for (const j of subgroupIndex) {
              let chord;
    ...
    chord.sortChords = function (_) {
      return arguments.length ? (_ == null ? sortChords = null
          : (sortChords = compareValue(_))._ = _, chord) : sortChords
          && sortChords._;
    };
  ...
  let Path$1 = class Path {
    ...
    arcTo(x1, y1, x2, y2, r) {
      ...
      // Otherwise, draw an arc!
        ...
        let x20 = x2 - x0,
            ...
            l01 = Math.sqrt(l01_2),
            l = r * Math.tan(
                (pi$2 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01)))
                / 2),
            t01 = l / l01,
            t21 = l / l21;
        ...
        this._append`A${r},${r},0,0,${+(y01 * x20 > x01 * y20)},${this._x1 = x1
            + t21 * x21},${this._y1 = y1 + t21 * y21}`;
      }
    }
    ...
    arc(x, y, r, a0, a1, ccw) {
      ...
      else if (Math.abs(this._x1 - x0) > epsilon$4 || Math.abs(this._y1 - y0)
          > epsilon$4) {
      ...
      if (da > tauEpsilon) {
        this._append`A${r},${r},0,1,${cw},${x - dx},${y
        - dy}A${r},${r},0,1,${cw},${this._x1 = x0},${this._y1 = y0}`;
      }

      // Is this arc non-empty? Draw an arc!
      else if (da > epsilon$4) {
        this._append`A${r},${r},0,${+(da >= pi$2)},${cw},${this._x1 = x + r
            * Math.cos(a1)},${this._y1 = y + r * Math.sin(a1)}`;
      }
    }
...
// Allow instanceof d3.path
    ...
    function ribbon() {
      ...
      if (ap > epsilon$5) {
        if (abs$2(sa1 - sa0) > ap * 2 + epsilon$5) {
          sa1 > sa0
              ? (sa0 += ap, sa1 -= ap) : (sa0 -= ap, sa1 += ap);
        } else {
          sa0 = sa1 = (sa0 + sa1) / 2;
        }
        if (abs$2(ta1 - ta0) > ap * 2 + epsilon$5) {
          ta1 > ta0
              ? (ta0 += ap, ta1 -= ap) : (ta0 -= ap, ta1 += ap);
        } else {
          ta0 = ta1 = (ta0 + ta1) / 2;
        }
      }
      ...
      if (sa0 !== ta0 || sa1 !== ta1) {
        if (headRadius) {
          var hr = +headRadius.apply(this, arguments), tr2 = tr - hr,
              ta2 = (ta0 + ta1) / 2;
  ...
  function area$3(ring) {
    ...
    while (++i < n) {
      area += ring[i - 1][1] * ring[i][0] - ring[i - 1][0]
          * ring[i][1];
    }
    return area;
  }
  ...
  function ringContains(ring, point) {
    ...
    for (var i = 0, n = ring.length, j = n - 1; i < n; j = i++) {
      var pi = ring[i], xi = pi[0], yi = pi[1], pj = ring[j], xj = pj[0],
          yj = pj[1];
  ...
  function Contours() {
    ...
    contours.thresholds = function (_) {
      return arguments.length ? (threshold = typeof _ === "function" ? _
          : Array.isArray(_) ? constant$5(slice$1.call(_)) : constant$5(
              _), contours) : threshold;
    };
...
// During smoothing, treat any invalid value as negative infinity.
  ...
  function density() {
    ...
    density.x = function (_) {
      return arguments.length ? (x = typeof _ === "function" ? _ : constant$5(
          +_), density) : x;
    };

    density.y = function (_) {
      return arguments.length ? (y = typeof _ === "function" ? _ : constant$5(
          +_), density) : y;
    };
  ...
  class Delaunator {
    ...
    update() {
      ...
      for (let i = 0; i < n; i++) {
        ...
        const r = circumradius(i0x, i0y, i1x, i1y, coords[2 * i],
            coords[2 * i + 1]);
        if (r < minRadius) {
          i2 = i;
          minRadius = r;
      ...
      if (minRadius === Infinity) {
        ...
        for (let i = 0; i < n; i++) {
          this._dists[i] = (coords[2 * i] - coords[0]) || (coords[2 * i + 1]
              - coords[1]);
        }
      ...
      for (let k = 0, xp, yp; k < this._ids.length; k++) {
        ...
        let e = start, q;
        while (q = hullNext[e], orient2d(x, y, coords[2 * e], coords[2 * e + 1],
        ...
        let n = hullNext[e];
        while (q = hullNext[n], orient2d(x, y, coords[2 * n], coords[2 * n + 1],
            coords[2 * q], coords[2 * q + 1]) < 0) {
        ...
        if (e === start) {
          while (q = hullPrev[e], orient2d(x, y, coords[2 * q],
              coords[2 * q + 1], coords[2 * e], coords[2 * e + 1]) < 0) {
...
// monotonically increases with real angle, but doesn't need expensive trigonometry
  ...
  class Voronoi {
    constructor(delaunay, [xmin, ymin, xmax, ymax] = [0, 0, 960, 500]) {
      if (!((xmax = +xmax) >= (xmin = +xmin)) || !((ymax = +ymax)
          >= (ymin = +ymin))) {
    ...
    _init() {
      ...
      for (let i = 0, j = 0, n = triangles.length, x, y; i < n;
          i += 3, j += 2) {
    ...
    renderBounds(context) {
      const buffer = context == null ? context = new Path : undefined;
      context.rect(this.xmin, this.ymin, this.xmax - this.xmin,
          this.ymax - this.ymin);
      return buffer && buffer.value();
    }
    ...
    renderCell(i, context) {
      ...
      let n = points.length;
      while (points[0] === points[n - 2] && points[1] === points[n - 1] && n
      > 1) {
        n -= 2;
      }
      for (let i = 2; i < n; i += 2) {
    ...
    * neighbors(i) {
    ...
    _clipFinite(i, points) {
      ...
      } else if (this.contains(i, (this.xmin + this.xmax) / 2,
    ...
    _clipSegment(x0, y0, x1, y1, c0, c1) {
      ...
      while (true) {
        if (c0 === 0 && c1 === 0) {
          return flip ? [x1, y1, x0, y0] : [x0, y0, x1,
            y1];
        }
        if (c0 & c1) {
          return null;
        ...
        let x, y, c = c0 || c1;
        if (c & 0b1000) {
          x = x0 + (x1 - x0) * (this.ymax - y0) / (y1
              - y0), y = this.ymax;
        } else if (c & 0b0100) {
          x = x0 + (x1 - x0) * (this.ymin - y0) / (y1
              - y0), y = this.ymin;
        } else if (c & 0b0010) {
          y = y0 + (y1 - y0) * (this.xmax - x0) / (x1
              - x0), x = this.xmax;
        } else {
    ...
    _clipInfinite(i, points, vx0, vy0, vxn, vyn) {
      ...
      if (P = this._clipFinite(i, P)) {
        for (let j = 0, n = P.length, c0,
            c1 = this._edgecode(P[n - 2], P[n - 1]); j < n; j += 2) {
    ...
    _simplify(P) {
      if (P && P.length > 4) {
        for (let i = 0; i < P.length; i += 2) {
          ...
          if (P[i] === P[j] && P[j] === P[k] || P[i + 1] === P[j + 1] && P[j
          + 1] === P[k + 1]) {
            P.splice(j, 2), i -= 2;
          }
        }
  ...
  class Delaunay {
    ...
    * neighbors(i) {
    ...
    _step(i, x, y) {
      ...
      do {
        let t = triangles[e];
        const dt = pow$2(x - points[t * 2], 2) + pow$2(y - points[t * 2 + 1],
            2);
        if (dt < dc) {
          dc = dt, c = t;
        }
    ...
    renderPoints(context, r) {
      if (r === undefined && (!context || typeof context.moveTo
          !== "function")) {
...
// Compute unique columns in order of discovery.
  ...
  function formatDate(date) {
    ...
    return isNaN(date) ? "Invalid Date"
        : formatYear$1(date.getUTCFullYear()) + "-" + pad$1(
            date.getUTCMonth() + 1, 2) + "-" + pad$1(date.getUTCDate(), 2)
        + (milliseconds ? "T" + pad$1(hours, 2) + ":" + pad$1(minutes, 2) + ":"
            ...
            : seconds ? "T" + pad$1(hours, 2) + ":" + pad$1(minutes, 2) + ":"
                + pad$1(seconds, 2) + "Z"
                : minutes || hours ? "T" + pad$1(hours, 2) + ":" + pad$1(
                    minutes, 2) + "Z"
                    : "");
  }
  ...
  function dsvFormat(delimiter) {
    ...
    function parse(text, f) {
      var convert, columns, rows = parseRows(text, function (row, i) {
        ...
        columns = row, convert = f ? customConverter(row, f) : objectConverter(
            row);
      });
    ...
    function format(rows, columns) {
      ...
      return [columns.map(formatValue).join(delimiter)].concat(
          preformatBody(rows, columns)).join("\n");
    }
...
// https://github.com/d3/d3-dsv/issues/45
  const fixtz = new Date("2019-01-01T00:00").getHours() || new Date(
  ...
  function dsvParse(parse) {
    return function (input, init, row) {
      if (arguments.length === 2 && typeof init
          === "function") {
  ...
  function dsv(delimiter, input, init, row) {
    if (arguments.length === 3 && typeof init
        === "function") {
      row = init, init = undefined;
    }
  ...
  function center(x, y) {
    ...
    function force() {
      ...
      for (sx = (sx / n - x) * strength, sy = (sy / n - y) * strength, i = 0;
          i < n; ++i) {
  ...
  function add(tree, x, y, d) {
    ...
    while (node.length) {
      ...
      if (parent = node, !(node = node[i = bottom << 1
          | right])) {
    ...
    if (x === xp && y === yp) {
      return leaf.next = node, parent ? parent[i] = leaf
  ...
  function addAll(data) {
    ...
    for (i = 0; i < n; ++i) {
      if (isNaN(x = +this._x.call(null, d = data[i])) || isNaN(
          y = +this._y.call(null, d))) {
        continue;
      }
      xz[i] = x;
  ...
  function tree_extent(_) {
    return arguments.length
        ...
        : isNaN(this._x0) ? undefined : [[this._x0, this._y0],
          [this._x1, this._y1]];
  }
  ...
  function tree_remove(d) {
    if (isNaN(x = +this._x.call(null, d)) || isNaN(
        y = +this._y.call(null, d))) {
      return this;
    } // ignore invalid points
    ...
    if (node.length) {
      while (true) {
        ...
        if (parent[(i + 1) & 3] || parent[(i + 2) & 3] || parent[(i + 3)
        & 3]) {
          retainer = parent, j = i;
        }
      }
  ...
  function tree_visitAfter(callback) {
    ...
    while (q = quads.pop()) {
      var node = q.node;
      if (node.length) {
        var child, x0 = q.x0, y0 = q.y0, x1 = q.x1, y1 = q.y1,
    ...
    while (node = nodes.pop()) {
      for (var i = 0; i < 4; ++i) {
        if (child = node.source[i]) {
          if (child.length) {
            nodes.push(
                {source: child, target: node.target[i] = new Array(4)});
          } else {
    ...
    function initialize() {
      ...
      for (i = 0, count = new Array(n); i < m; ++i) {
        ...
        if (typeof link.source !== "object") {
          link.source = find(nodeById,
              link.source);
        }
        if (typeof link.target !== "object") {
          link.target = find(nodeById,
              link.target);
        }
...
// https://en.wikipedia.org/wiki/Linear_congruential_generator#Parameters_in_common_use
  ...
  function simulation(nodes) {
    ...
    return simulation = {
      ...
      nodes: function (_) {
        return arguments.length ? (nodes = _, initializeNodes(), forces.forEach(
            initializeForce), simulation) : nodes;
      },
      ...
      randomSource: function (_) {
        return arguments.length ? (random = _, forces.forEach(
            initializeForce), simulation) : random;
      },

      force: function (name, _) {
        return arguments.length > 1 ? ((_ == null ? forces.delete(name)
            : forces.set(name, initializeForce(_))), simulation) : forces.get(
            name);
      },
  ...
  function manyBody() {
    ...
    function initialize() {
      ...
      for (i = 0; i < n;
          ++i) {
        node = nodes[i], strengths[node.index] = +strength(node, i,
            nodes);
      }
    }
    ...
    force.distanceMin = function (_) {
      return arguments.length ? (distanceMin2 = _ * _, force) : Math.sqrt(
          distanceMin2);
    };

    force.distanceMax = function (_) {
      return arguments.length ? (distanceMax2 = _ * _, force) : Math.sqrt(
          distanceMax2);
    };
  ...
  function x$1(x) {
    ...
    function initialize() {
      ...
      xz = new Array(n);
      for (i = 0; i < n; ++i) {
        strengths[i] = isNaN(xz[i] = +x(nodes[i], i, nodes)) ? 0 : +strength(
            nodes[i], i, nodes);
      }
    }
    ...
    force.x = function (_) {
      return arguments.length ? (x = typeof _ === "function" ? _ : constant$4(
          +_), initialize(), force) : x;
    };
  ...
  function y$1(y) {
    ...
    function initialize() {
      ...
      yz = new Array(n);
      for (i = 0; i < n; ++i) {
        strengths[i] = isNaN(yz[i] = +y(nodes[i], i, nodes)) ? 0 : +strength(
            nodes[i], i, nodes);
      }
    }
    ...
    force.y = function (_) {
      return arguments.length ? (y = typeof _ === "function" ? _ : constant$4(
          +_), initialize(), force) : y;
    };
...
// [[fill]align][sign][symbol][0][width][,][.precision][~][type]
  ...
  FormatSpecifier.prototype.toString = function () {
    return this.fill
        ...
        + (this.comma ? "," : "")
        + (this.precision === undefined ? "" : "." + Math.max(0,
            this.precision | 0))
        + (this.trim ? "~" : "")
        + this.type;
  };
...
// Trims insignificant zeros, e.g., replaces 1.2000k with 1.2k.
  ...
  function formatPrefixAuto(x, p) {
    ...
    var coefficient = d[0],
        exponent = d[1],
        i = exponent - (prefixExponent = Math.max(-8,
            Math.min(8, Math.floor(exponent / 3))) * 3) + 1,
        n = coefficient.length;
    return i === n ? coefficient
        : i > n ? coefficient + new Array(i - n + 1).join("0")
            : i > 0 ? coefficient.slice(0, i) + "." + coefficient.slice(i)
                : "0." + new Array(1 - i).join("0") + formatDecimalParts(x,
                Math.max(0, p + i - 1))[0]; // less than 1y!
  }
  ...
  var map = Array.prototype.map,
      prefixes = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G",
        "T", "P", "E", "Z", "Y"];

  function formatLocale$1(locale) {
    var group = locale.grouping === undefined || locale.thousands === undefined
            ? identity$6 : formatGroup(map.call(locale.grouping, Number),
                locale.thousands + ""),
        ...
        numerals = locale.numerals === undefined ? identity$6 : formatNumerals(
      ...
      function format(value) {
        ...
        if (comma && zero) {
          value = group(padding + value,
              padding.length ? width - valueSuffix.length
                  : Infinity), padding = "";
        }
    ...
    function formatPrefix(specifier, value) {
      var f = newFormat((specifier = formatSpecifier(
              specifier), specifier.type = "f", specifier)),
  ...
  var streamGeometryType = {
    ...
    MultiPoint: function (object, stream) {
      ...
      while (++i < n) {
        object = coordinates[i], stream.point(object[0],
            object[1], object[2]);
      }
    },
  ...
  function streamLine(coordinates, stream, closed) {
    ...
    stream.lineStart();
    while (++i < n) {
      coordinate = coordinates[i], stream.point(coordinate[0],
...
// hello?
  ...
  function areaPointFirst$1(lambda, phi) {
    ...
    lambda0$2 = lambda, cosPhi0$1 = cos$1(
        phi = phi / 2 + quarterPi), sinPhi0$1 = sin$1(phi);
  }
...
// TODO return d
  ...
  function linePoint(lambda, phi) {
    ...
    if (p0) {
      ...
      if (antimeridian ^ (sign * lambda2 < lambdai && lambdai < sign
          * lambda)) {
      ...
      if (antimeridian) {
        if (lambda < lambda2) {
          if (angle(lambda0$1, lambda) > angle(lambda0$1,
              lambda1)) {
            lambda1 = lambda;
          }
        } else {
          if (angle(lambda, lambda1) > angle(lambda0$1,
              lambda1)) {
            lambda0$1 = lambda;
          }
        }
...
// the distance between ±180° to be 360°.
  ...
  function bounds(feature) {
    ...
    if (n = ranges.length) {
      ...
      for (deltaMax = -Infinity, n = merged.length - 1, i = 0, a = merged[n];
          i <= n; a = b, ++i) {
        b = merged[i];
        if ((delta = angle(a[1], b[0]))
            > deltaMax) {
...
// Arithmetic mean of Cartesian vectors.
  ...
  function centroidLinePoint(lambda, phi) {
    ...
    var cosPhi = cos$1(phi),
        ...
        z = sin$1(phi),
        w = atan2$1(sqrt$2(
            (w = y0$4 * z - z0 * y) * w + (w = z0 * x - x0$4 * z) * w
            + (w = x0$4 * y - y0$4 * x) * w), x0$4 * x + y0$4 * y + z0 * z);
    W1 += w;
    X1$1 += w * (x0$4 + (x0$4 = x));
    Y1$1 += w * (y0$4 + (y0$4 = y));
    Z1$1 += w * (z0 + (z0 = z));
...
// J. Applied Mechanics 42, 239 (1975).
  ...
  function rotateRadians(deltaLambda, deltaPhi, deltaGamma) {
    return (deltaLambda %= tau$1) ? (deltaPhi || deltaGamma ? compose(
                rotationLambda(deltaLambda), rotationPhiGamma(deltaPhi, deltaGamma))
  ...
  function rotationPhiGamma(deltaPhi, deltaGamma) {
    ...
    function rotation(lambda, phi) {
      ...
      return [
        atan2$1(y * cosDeltaGamma - k * sinDeltaGamma,
    ...
    rotation.invert = function (lambda, phi) {
      ...
      return [
        atan2$1(y * cosDeltaGamma + z * sinDeltaGamma,
  ...
  function rotation(rotate) {
    ...
    forward.invert = function (coordinates) {
      coordinates = rotate.invert(coordinates[0] * radians,
...
// Generates a circle centered at [0°, 0°], with a given radius and precision.
  function circleStream(stream, radius, delta, direction, t0, t1) {
    ...
    for (var point, t = t0; direction > 0 ? t > t1 : t < t1; t -= step) {
      point = spherical(
          [cosRadius, -sinRadius * cos$1(t), -sinRadius * sin$1(t)]);
...
// along the clip edge.
  ...
  function longitude(point) {
    return abs$1(point[0]) <= pi$1 ? point[0] : sign$1(point[0]) * ((abs$1(
        point[0]) + pi$1) % tau$1 - pi$1);
  }
  ...
  function polygonContains(polygon, point) {
    ...
    for (var i = 0, n = polygon.length; i < n; ++i) {
      ...
      for (var j = 0; j < m;
        ...
        sum.add(atan2$1(k * sign * sin$1(absDelta),
        ...
        if (antimeridian ^ lambda0 >= lambda ^ lambda1 >= lambda) {
          ...
          var phiArc = (antimeridian ^ delta >= 0 ? -1 : 1) * asin$1(
              intersection[2]);
...
// intersections, and the first and last segments should be rejoined.
  ...
  function clipCircle(radius) {
    ...
    function intersect(a, b, two) {
      ...
      if (meridian
          ? polar
              ? phi0 + phi1 > 0 ^ q[1] < (abs$1(q[0] - lambda0) < epsilon$1
              ? phi0 : phi1)
              : phi0 <= q[1] && q[1] <= phi1
...
// TODO Eliminate duplicate buffering in clipBuffer and polygon.push?
      ...
      function linePoint(x, y) {
        ...
        if (first) {
          ...
          if (v && v_) {
            ...
            var a = [x_ = Math.max(clipMin, Math.min(clipMax, x_)),
                  y_ = Math.max(clipMin, Math.min(clipMax, y_))],
                b = [x = Math.max(clipMin, Math.min(clipMax, x)),
  ...
  function extent() {
    ...
    return clip = {
      stream: function (stream) {
        return cache && cacheStream === stream ? cache : cache = clipRectangle(
            x0, y0, x1, y1)(cacheStream = stream);
      },
      extent: function (_) {
        return arguments.length
  ...
  var containsObjectType = {
    ...
    FeatureCollection: function (object, point) {
      var features = object.features, i = -1, n = features.length;
      while (++i < n) {
        if (containsGeometry(features[i].geometry,
            point)) {
          return true;
        }
      }
  ...
  function interpolate(a, b) {
    var x0 = a[0] * radians,
        ...
        ky1 = cy1 * sin$1(x1),
        d = 2 * asin$1(
            sqrt$2(haversin(y1 - y0) + cy0 * cy1 * haversin(x1 - x0))),
        k = sin$1(d);
...
// Simple caching for constant-radius points.
      ...
      switch (this._point) {
        ...
        default: {
          ...
          if (this._radius !== cacheRadius || this._append !== cacheAppend) {
            ...
            this._append`m0,${r}a${r},${r} 0 1,1 0,${-2
            * r}a${r},${r} 0 1,1 0,${2 * r}z`;
            cacheRadius = r;
  ...
  function index$2(projection, context) {
    ...
    path.projection = function (_) {
      ...
      projectionStream = _ == null ? (projection = null, identity$5)
          : (projection = _).stream;
      return path;
    };
    ...
    path.context = function (_) {
      ...
      contextStream = _ == null ? (context = null, new PathString(digits))
    ...
    function resampleLineTo(x0, y0, lambda0, a0, b0, c0, x1, y1, lambda1, a1,
      ...
      if (d2 > 4 * delta2 && depth--) {
        var a = a0 + a1,
            ...
            phi2 = asin$1(c /= m),
            lambda2 = abs$1(abs$1(c) - 1) < epsilon$1 || abs$1(
                lambda0 - lambda1) < epsilon$1 ? (lambda0 + lambda1) / 2
                : atan2$1(b, a),
    ...
    return function (stream) {
      ...
      function linePoint(lambda, phi) {
        ...
        resampleLineTo(x0, y0, lambda0, a0, b0, c0, x0 = p[0], y0 = p[1],
            lambda0 = lambda, a0 = c[0], b0 = c[1], c0 = c[2], maxDepth,
            stream);
        stream.point(x0, y0);
      }
      ...
      function ringPoint(lambda, phi) {
        linePoint(lambda00 = lambda,
            phi), x00 = x0, y00 = y0, a00 = a0, b00 = b0, c00 = c0;
        resampleStream.point = linePoint;
      }
  ...
  function projectionMutator(projectAt) {
    ...
    projection.postclip = function (_) {
      return arguments.length
          ? (postclip = _, x0 = y0 = x1 = y1 = null, reset()) : postclip;
    };
    ...
    projection.clipExtent = function (_) {
      return arguments.length ? (postclip = _ == null
          ? (x0 = y0 = x1 = y1 = null, identity$5) : clipRectangle(
              x0 = +_[0][0], y0 = +_[0][1], x1 = +_[1][0],
              y1 = +_[1][1]), reset()) : x0 == null ? null : [[x0, y0],
        [x1, y1]];
    };
    ...
    projection.rotate = function (_) {
      return arguments.length ? (deltaLambda = _[0] % 360
          * radians, deltaPhi = _[1] % 360 * radians, deltaGamma = _.length > 2
          ? _[2] % 360 * radians : 0, recenter()) : [deltaLambda * degrees,
        deltaPhi * degrees, deltaGamma * degrees];
    };
...
// http://egsc.usgs.gov/isb/pubs/MapProjections/projections.html#albers
  function albersUsa() {
    ...
    albersUsa.stream = function (stream) {
      return cache && cacheStream === stream ? cache : cache = multiplex(
          [lower48.stream(cacheStream = stream), alaska.stream(stream),
  ...
  function conicConformalRaw(y0, y1) {
    var cy0 = cos$1(y0),
        n = y0 === y1 ? sin$1(y0) : log$1(cy0 / cos$1(y1)) / log$1(
            tany(y1) / tany(y0)),
  ...
  function equalEarthRaw(lambda, phi) {
    ...
    return [
      lambda * cos$1(l) / (M * (A1 + 3 * A2 * l2 + l6 * (7 * A3 + 9 * A4
          * l2))),
  ...
  function identity$4() {
    ...
    projection.stream = function (stream) {
      return cache && cacheStream === stream ? cache : cache = transform(
    ...
    projection.angle = function (_) {
      return arguments.length ? (alpha = _ % 360 * radians, sa = sin$1(
          alpha), ca = cos$1(alpha), reset()) : alpha * degrees;
    };
    projection.reflectX = function (_) {
  ...
  function transverseMercator() {
    ...
    m.rotate = function (_) {
      return arguments.length ? rotate(
          [_[0], _[1], _.length > 2 ? _[2] + 90 : 90]) : (_ = rotate(), [_[0],
        _[1], _[2] - 90]);
    };
  ...
  function cluster() {
    ...
    cluster.size = function (x) {
      return arguments.length
          ? (nodeSize = false, dx = +x[0], dy = +x[1], cluster) : (nodeSize
              ? null : [dx, dy]);
    };

    cluster.nodeSize = function (x) {
      return arguments.length
          ? (nodeSize = true, dx = +x[0], dy = +x[1], cluster) : (nodeSize
              ? [dx, dy] : null);
    };
  ...
  function hierarchy(data, children) {
    ...
    while (node = nodes.pop()) {
      if ((childs = children(node.data)) && (n = (childs = Array.from(
          childs)).length)) {
...
// https://en.wikipedia.org/wiki/Linear_congruential_generator#Parameters_in_common_use
  ...
  function packEncloseRandom(circles, random) {
    var i = 0, n = (circles = shuffle(Array.from(circles), random)).length,
        B = [], p, e;
  ...
  function encloseBasis3(a, b, c) {
    var x1 = a.x, y1 = a.y, r1 = a.r,
        ...
        B = 2 * (r1 + xa * xb + ya * yb),
        C = xa * xa + ya * ya - r1 * r1,
        r = -(Math.abs(A) > 1e-6 ? (B + Math.sqrt(B * B - 4 * A * C)) / (2 * A)
            : C / B);
    return {
      x: x1 + xa + xb * r,
      y: y1 + ya + yb * r,
...
// Node-link tree diagram using the Reingold-Tilford "tidy" algorithm
  ...
  function squarifyRatio(ratio, parent, x0, y0, x1, y1) {
    ...
    while (i0 < n) {
      ...
      if (row.dice) {
        ...
        treemapSlice(row, x0, y0, value ? x0 += dx * sumValue / value : x1,
            y1);
      }
  ...
  function index() {
    ...
    treemap.paddingOuter = function (x) {
      return arguments.length ? treemap.paddingTop(x).paddingRight(
          x).paddingBottom(x).paddingLeft(x) : treemap.paddingTop();
    };
  ...
  function binary(parent, x0, y0, x1, y1) {
    ...
    function partition(i, j, value, x0, y0, x1, y1) {
      ...
      if ((valueTarget - sums[k - 1]) < (sums[k] - valueTarget) && i + 1
          < k) {
        --k;
      }
    ...
    function resquarify(parent, x0, y0, x1, y1) {
      if ((rows = parent._squarify) && (rows.ratio === ratio)) {
        ...
        while (++j < m) {
          ...
          for (i = row.value = 0, n = nodes.length; i < n;
              ++i) {
          ...
          if (row.dice) {
            ...
            treemapSlice(row, x0, y0,
                value ? x0 += (x1 - x0) * row.value / value : x1, y1);
          }
          value -= row.value;
        }
      } else {
...
// Returns an array of indices into points in left-to-right order.
  function computeUpperHullIndexes(points) {
    ...
    for (i = 2; i < n; ++i) {
      while (size > 1 && cross$1(points[indexes[size - 2]],
  ...
  function hull(points) {
    ...
    for (i = 0; i < n; ++i) {
      flippedPoints[i] = [sortedPoints[i][0],
        -sortedPoints[i][1]];
    }
    ...
    for (i = upperIndexes.length - 1; i >= 0; --i) {
      hull.push(
          points[sortedPoints[upperIndexes[i]][2]]);
    }
  ...
  var poisson = (function sourceRandomPoisson(source) {
    ...
    function randomPoisson(lambda) {
      return function () {
        ...
        for (var s = -Math.log1p(-source()), k = 0; s <= l;
            ++k) {
          s -= Math.log1p(-source());
        }
        return acc + k;
...
// https://en.wikipedia.org/wiki/Linear_congruential_generator#Parameters_in_common_use
  ...
  function band() {
    ...
    scale.padding = function (_) {
      return arguments.length ? (paddingInner = Math.min(1,
          paddingOuter = +_), rescale()) : paddingInner;
    };
...
// interpolate(a, b)(t) takes a parameter t in [0,1] and returns the corresponding range value x in [a,b].
  ...
  function transformer$2() {
    ...
    function scale(x) {
      return x == null || isNaN(x = +x) ? unknown : (output
    ...
    scale.invert = function (y) {
      return clamp(untransform(
          (input || (input = piecewise(range, domain.map(transform),
              interpolateNumber)))(y)));
    };
    ...
    switch (specifier.type) {
      case "s": {
        ...
        if (specifier.precision == null && !isNaN(
            precision = precisionPrefix(step,
                value))) {
      ...
      case "r": {
        if (specifier.precision == null && !isNaN(
            precision = precisionRound(step, Math.max(Math.abs(start),
                Math.abs(stop))))) {
          specifier.precision = precision
              - (specifier.type === "e");
        }
  ...
  function loggish(transform) {
    ...
    scale.tickFormat = (count, specifier) => {
      ...
      if (typeof specifier !== "function") {
        if (!(base % 1) && (specifier = formatSpecifier(specifier)).precision
            == null) {
          specifier.trim = true;
        }
  ...
  function radial() {
    ...
    scale.range = function (_) {
      return arguments.length ? (squared.range(
              (range = Array.from(_, number$1)).map(square$1)), scale)
          : range.slice();
    };
  ...
  function quantile() {
    ...
    function scale(x) {
      return x == null || isNaN(x = +x) ? unknown : range[bisect(thresholds,
          x)];
    }
  ...
  function quantize() {
    ...
    scale.range = function (_) {
      return arguments.length ? (n = (range = Array.from(_)).length
          - 1, rescale()) : range.slice();
    };
  ...
  function threshold() {
    ...
    scale.domain = function (_) {
      return arguments.length ? (domain = Array.from(_), n = Math.min(
          domain.length, range.length - 1), scale) : domain.slice();
    };

    scale.range = function (_) {
      return arguments.length ? (range = Array.from(_), n = Math.min(
          domain.length, range.length - 1), scale) : range.slice();
    };
  ...
  function timeInterval(floori, offseti, count, field) {
    ...
    function interval(date) {
      return floori(
          date = arguments.length === 0 ? new Date : new Date(+date)), date;
    }
    ...
    interval.ceil = (date) => {
      return floori(date = new Date(date - 1)), offseti(date, 1), floori(
          date), date;
    };
    ...
    interval.offset = (date, step) => {
      return offseti(date = new Date(+date),
          step == null ? 1 : Math.floor(step)), date;
    };
    ...
    interval.range = (start, stop, step) => {
      ...
      let previous;
      do {
        range.push(previous = new Date(+start)), offseti(start, step), floori(
            start);
...
// An optimized implementation for this simple case.
  ...
  const [utcTicks, utcTickInterval] = ticker(utcYear, utcMonth, utcSunday,
      unixDay, utcHour, utcMinute);
  const [timeTicks, timeTickInterval] = ticker(timeYear, timeMonth, timeSunday,
      timeDay, timeHour, timeMinute);
      ...
      return function (date) {
        ...
        while (++i < n) {
          if (specifier.charCodeAt(i) === 37) {
            ...
            if ((pad = pads[c = specifier.charAt(++i)])
                != null) {
      ...
      return function (string) {
        ...
        if ("V" in d) {
          ...
          if ("Z" in d) {
            ...
            week = day > 4 || day === 0 ? utcMonday.ceil(week) : utcMonday(
                week);
            ...
            week = day > 4 || day === 0 ? timeMonday.ceil(week) : timeMonday(
                week);
          ...
          day = "Z" in d ? utcDate(newDate(d.y, 0, 1)).getUTCDay() : localDate(
              newDate(d.y, 0, 1)).getDay();
          d.m = 0;
          d.d = "W" in d ? (d.w + 6) % 7 + d.W * 7 - (day + 5) % 7 : d.w + d.U
              * 7 - (day + 6) % 7;
        }
  ...
  function formatWeekNumberISO(d, p) {
    d = dISO(d);
    return pad(
        timeThursday.count(timeYear(d), d) + (timeYear(d).getDay() === 4), p,
        2);
  }
  ...
  function formatUTCWeekNumberISO(d, p) {
    d = UTCdISO(d);
    return pad(
        utcThursday.count(utcYear(d), d) + (utcYear(d).getUTCDay() === 4), p,
        2);
  }
  ...
  function calendar(ticks, tickInterval, year, month, week, day, hour, minute,
          ...
          : minute(date) < date ? formatSecond
              : hour(date) < date ? formatMinute
                  : day(date) < date ? formatHour
                      : month(date) < date ? (week(date) < date ? formatDay
                              : formatWeek)
    ...
    scale.domain = function (_) {
      return arguments.length ? domain(Array.from(_, number)) : domain().map(
          date);
    };
    ...
    scale.nice = function (interval) {
      var d = domain();
      if (!interval || typeof interval.range
          !== "function") {
        interval = tickInterval(d[0], d[d.length - 1],
    ...
    scale.copy = function () {
      return copy$1(scale,
          calendar(ticks, tickInterval, year, month, week, day, hour, minute,
              second, format));
    };
  ...
  function time() {
    return initRange.apply(
        calendar(timeTicks, timeTickInterval, timeYear, timeMonth, timeSunday,
            timeDay, timeHour, timeMinute, second, exports.timeFormat).domain(
            [new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
  }

  function utcTime() {
    return initRange.apply(
        calendar(utcTicks, utcTickInterval, utcYear, utcMonth, utcSunday,
            utcDay, utcHour, utcMinute, second, exports.utcFormat).domain(
            [Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]), arguments);
  }
  ...
  function transformer$1() {
    ...
    function scale(x) {
      return x == null || isNaN(x = +x) ? unknown : interpolator(
          k10 === 0 ? 0.5 : (x = (transform(x) - t0) * k10, clamp ? Math.max(0,
              Math.min(1, x)) : x));
    }

    scale.domain = function (_) {
      return arguments.length ? ([x0, x1] = _, t0 = transform(
          x0 = +x0), t1 = transform(x1 = +x1), k10 = t0 === t1 ? 0 : 1 / (t1
          - t0), scale) : [x0, x1];
    };
    ...
    return function (t) {
      transform = t, t0 = t(x0), t1 = t(x1), k10 = t0 === t1 ? 0 : 1 / (t1
          - t0);
      return scale;
    };
  }
  ...
  function transformer() {
    ...
    function scale(x) {
      return isNaN(x = +x) ? unknown : (x = 0.5 + ((x = +transform(x)) - t1)
          * (s * x < s * t1 ? k10 : k21), interpolator(
          clamp ? Math.max(0, Math.min(1, x)) : x));
    }

    scale.domain = function (_) {
      return arguments.length ? ([x0, x1, x2] = _, t0 = transform(
          x0 = +x0), t1 = transform(x1 = +x1), t2 = transform(
          x2 = +x2), k10 = t0 === t1 ? 0 : 0.5 / (t1 - t0), k21 = t1 === t2 ? 0
          : 0.5 / (t2 - t1), s = t1 < t0 ? -1 : 1, scale) : [x0, x1, x2];
    };
    ...
    function range(interpolate) {
      return function (_) {
        var r0, r1, r2;
        return arguments.length ? ([r0, r1, r2] = _, interpolator = piecewise(
            interpolate, [r0, r1, r2]), scale) : [interpolator(0),
    ...
    return function (t) {
      transform = t, t0 = t(x0), t1 = t(x1), t2 = t(x2), k10 = t0 === t1 ? 0
          : 0.5 / (t1 - t0), k21 = t1 === t2 ? 0 : 0.5 / (t2 - t1), s = t1 < t0
          ? -1 : 1;
      return scale;
    };
  }
  ...
  function cividis(t) {
    ...
    return "rgb("
        + Math.max(0, Math.min(255, Math.round(
            -4.54 - t * (35.34 - t * (2381.73 - t * (6402.7 - t * (7024.72 - t
                * 2710.57))))))) + ", "
        + Math.max(0, Math.min(255, Math.round(
            32.49 + t * (170.73 + t * (52.82 - t * (131.46 - t * (176.58 - t
                * 67.37))))))) + ", "
        + Math.max(0, Math.min(255, Math.round(
            81.24 + t * (442.36 - t * (2482.43 - t * (6167.24 - t * (6614.94 - t
                * 2475.67)))))))
        + ")";
  }

  var cubehelix = cubehelixLong(cubehelix$3(300, 0.5, 0.0),
      cubehelix$3(-240, 0.5, 1.0));

  var warm = cubehelixLong(cubehelix$3(-100, 0.75, 0.35),
      cubehelix$3(80, 1.50, 0.8));

  var cool = cubehelixLong(cubehelix$3(260, 0.75, 0.35),
      cubehelix$3(80, 1.50, 0.8));
  ...
  function turbo(t) {
    ...
    return "rgb("
        + Math.max(0, Math.min(255, Math.round(
            34.61 + t * (1172.33 - t * (10793.56 - t * (33300.12 - t * (38394.49
                - t * 14825.05))))))) + ", "
        + Math.max(0, Math.min(255, Math.round(
            23.31 + t * (557.33 + t * (1225.33 - t * (3574.96 - t * (1073.77 + t
                * 707.56))))))) + ", "
        + Math.max(0, Math.min(255, Math.round(
            27.2 + t * (3211.1 - t * (15327.97 - t * (27814 - t * (22569.18 - t
                * 6838.66)))))))
        + ")";
  }
...
// http://mathworld.wolfram.com/Circle-LineIntersection.html
          ...
          if (da < pi) {
            if (oc = intersect(x01, y01, x00, y00, x11, y11, x10, y10)) {
              var ax = x01 - oc[0],
                  ...
                  by = y11 - oc[1],
                  kc = 1 / sin(acos(
                      (ax * bx + ay * by) / (sqrt(ax * ax + ay * ay) * sqrt(
                          bx * bx + by * by))) / 2),
  ...
  Linear.prototype = {
    ...
    lineEnd: function () {
      if (this._line || (this._line !== 0 && this._point
          === 1)) {
        this._context.closePath();
      }
  ...
  function line(x$1, y$1) {
    ...
    line.x = function (_) {
      return arguments.length ? (x$1 = typeof _ === "function" ? _ : constant$1(
          +_), line) : x$1;
    };

    line.y = function (_) {
      return arguments.length ? (y$1 = typeof _ === "function" ? _ : constant$1(
          +_), line) : y$1;
    };
    ...
    line.curve = function (_) {
      return arguments.length ? (curve = _, context != null && (output = curve(
          context)), line) : curve;
    };

    line.context = function (_) {
      return arguments.length ? (_ == null ? context = output = null
          : output = curve(context = _), line) : context;
    };
  ...
  function area(x0, y0, y1) {
    ...
    x0 = typeof x0 === "function" ? x0 : (x0 === undefined) ? x : constant$1(
        +x0);
    y0 = typeof y0 === "function" ? y0 : (y0 === undefined) ? constant$1(0)
        : constant$1(+y0);
    y1 = typeof y1 === "function" ? y1 : (y1 === undefined) ? y : constant$1(
        +y1);
    ...
    function area(data) {
      ...
      for (i = 0; i <= n; ++i) {
        ...
        if (defined0) {
          ...
          output.point(x1 ? +x1(d, i, data) : x0z[i],
    ...
    area.x = function (_) {
      return arguments.length ? (x0 = typeof _ === "function" ? _ : constant$1(
          +_), x1 = null, area) : x0;
    };
    ...
    area.y = function (_) {
      return arguments.length ? (y0 = typeof _ === "function" ? _ : constant$1(
          +_), y1 = null, area) : y0;
    };
    ...
    area.context = function (_) {
      return arguments.length ? (_ == null ? context = output = null
          : output = curve(context = _), area) : context;
    };
  ...
  function pie() {
    ...
    function pie(data) {
      ...
      for (i = 0, k = sum ? (da - n * pa) / sum : 0; i < n; ++i, a0 = a1) {
        j = index[i], v = arcs[j], a1 = a0 + (v > 0 ? v * k : 0)
            + pa, arcs[j] = {
          data: data[j],
          index: i,
          value: v,
        ...
        default: {
          if (this._x) {
            this._context.bezierCurveTo(
                this._x0 = (this._x0 + x) / 2, this._y0, this._x0, y, x, y);
          } else {
            this._context.bezierCurveTo(this._x0,
                this._y0 = (this._y0 + y) / 2, x, this._y0, x, y);
          }
          break;
        }
      }
  ...
  function link(curve) {
    ...
    link.context = function (_) {
      return arguments.length ? (_ == null ? context = output = null
          : output = curve(context = _), link) : context;
    };
...
// These symbols are designed to be stroked (with a width of 1.5px and round caps).
  ...
  function Symbol$1(type, size) {
    ...
    size = typeof size === "function" ? size : constant$1(
      ...
      switch (this._point) {
        ...
        case 2:
          ...
          this._context.lineTo((5 * this._x0 + this._x1) / 6,
              (5 * this._y0 + this._y1) / 6); // falls through
        default:
          point$3(this, x, y);
          break;
      }
  ...
  BasisClosed.prototype = {
    ...
    lineEnd: function () {
      switch (this._point) {
        ...
        case 2: {
          this._context.moveTo((this._x2 + 2 * this._x3) / 3,
              (this._y2 + 2 * this._y3) / 3);
          this._context.lineTo((this._x3 + 2 * this._x2) / 3,
    ...
    point: function (x, y) {
      ...
      switch (this._point) {
        ...
        case 2:
          ...
          this._line ? this._context.lineTo(x0, y0) : this._context.moveTo(x0,
              y0);
          break;
        case 3:
  ...
  CardinalOpen.prototype = {
    ...
    point: function (x, y) {
      ...
      switch (this._point) {
        ...
        case 2:
          this._point = 3;
          this._line ? this._context.lineTo(this._x2, this._y2)
              : this._context.moveTo(this._x2, this._y2);
          break;
        case 3:
          this._point = 4; // falls through
  ...
  var catmullRomClosed = (function custom(alpha) {
    ...
    function catmullRom(context) {
      return alpha ? new CatmullRomClosed(context, alpha) : new CardinalClosed(
          context, 0);
    }
  ...
  var catmullRomOpen = (function custom(alpha) {
    ...
    function catmullRom(context) {
      return alpha ? new CatmullRomOpen(context, alpha) : new CardinalOpen(
          context, 0);
    }
...
// NOV(II), P. 443, 1990.
  function slope3(that, x2, y2) {
    var h0 = that._x1 - that._x0,
        ...
        p = (s0 * h1 + s1 * h0) / (h0 + h1);
    return (sign(s0) + sign(s1)) * Math.min(Math.abs(s0), Math.abs(s1),
        0.5 * Math.abs(p)) || 0;
  }
...
// with respect to the four values p0, p0 + m0 / 3, p1 - m1 / 3, p1".
  ...
  (MonotoneY.prototype = Object.create(
      MonotoneX.prototype)).point = function (x, y) {
...
// See https://www.particleincell.com/2012/bezier-splines/ for derivation.
  function controlPoints(x) {
    ...
    for (i = 1; i < n - 1; ++i) {
      a[i] = 1, b[i] = 4, r[i] = 4 * x[i] + 2 * x[i
      + 1];
    }
    a[n - 1] = 2, b[n - 1] = 7, r[n - 1] = 8 * x[n - 1] + x[n];
    for (i = 1; i < n; ++i) {
      m = a[i] / b[i - 1], b[i] -= m, r[i] -= m * r[i
      - 1];
    }
    a[n - 1] = r[n - 1] / b[n - 1];
    for (i = n - 2; i >= 0; --i) {
  ...
  function none$1(series, order) {
    ...
    for (var i = 1, j, s0, s1 = series[order[0]], n, m = s1.length; i < n;
        ++i) {
  ...
  Transform.prototype = {
    ...
    translate: function (x, y) {
      return x === 0 & y === 0 ? this : new Transform(this.k,
          this.x + this.k * x, this.y + this.k * y);
    },
    ...
    rescaleX: function (x) {
      return x.copy().domain(
          x.range().map(this.invertX, this).map(x.invert, x));
    },
    rescaleY: function (y) {
      return y.copy().domain(
          y.range().map(this.invertY, this).map(y.invert, y));
    },
    toString: function () {
...
// except for pinch-to-zoom, which is sent as a wheel+ctrlKey event
  ...
  function zoom() {
    ...
    zoom.transform = function (collection, transform, point, event) {
      var selection = collection.selection ? collection.selection()
          : collection;
      ...
      if (collection !== selection) {
        ...
        selection.interrupt().each(function () {
          ...
          .start()
          .zoom(null,
              typeof transform === "function" ? transform.apply(this, arguments)
                  : transform)
          .end();
        });
      }
    ...
    zoom.scaleTo = function (selection, k, p, event) {
      zoom.transform(selection, function () {
        var e = extent.apply(this, arguments),
            t0 = this.__zoom,
            p0 = p == null ? centroid(e) : typeof p === "function" ? p.apply(
                this, arguments) : p,
            p1 = t0.invert(p0),
            k1 = typeof k === "function" ? k.apply(this, arguments) : k;
    ...
    function translate(transform, p0, p1) {
      ...
      return x === transform.x && y === transform.y ? transform : new Transform(
          transform.k, x, y);
    }
    ...
    function schedule(transition, transform, point, event) {
      ...
      .tween("zoom", function () {
        var that = this,
            ...
            a = that.__zoom,
            b = typeof transform === "function" ? transform.apply(that, args)
                : transform,
    ...
    function mousedowned(event, ...args) {
      ...
      function mousemoved(event) {
        ...
        g.event(event)
        .zoom("mouse", constrain(
            translate(g.that.__zoom, g.mouse[0] = pointer(event, currentTarget),
                g.mouse[1]), g.extent, translateExtent));
      }
    ...
    function dblclicked(event, ...args) {
      ...
      var t0 = this.__zoom,
          ...
          t1 = constrain(translate(scale(t0, k1), p0, p1),
              extent.apply(this, args), translateExtent);

      noevent(event);
      if (duration > 0) {
        select(this).transition().duration(duration).call(
            schedule, t1, p0, event);
      } else {
    ...
    function touchstarted(event, ...args) {
      ...
      for (i = 0; i < n; ++i) {
        ...
        if (!g.touch0) {
          g.touch0 = p, started = true, g.taps = 1
              + !!touchstarting;
      ...
      if (started) {
        if (g.taps < 2) {
          touchfirst = p[0], touchstarting = setTimeout(
              function () {
                touchstarting = null;
              }, touchDelay);
        }
    ...
    zoom.extent = function (_) {
      return arguments.length ? (extent = typeof _ === "function" ? _
              : constant([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom)
          : extent;
    };
